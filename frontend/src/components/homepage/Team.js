        ...
        <div id='team' className='text-center'>
            <div className='container'>
                <div className='col-md-8 col-md-offset-2 section-title'>
                    ...
                    <p>
                        O Meu Tesourinho surgiu da necessidade de desolvever um projeto que integrasse todos os conhecimentos adquiridos no curso de FullStack da DH. <br />Idealizado e desenvolvido pelas unicas mulheres da turma! <br />
